...
<div class='form_field'>
 <select name="store_list[]" style="font-family: 'Courier New', Courier, monospace;width:180px;">
    <option value="0">All Store Locations</option>
    <?php foreach($locations as $location) :?>
      <option value="<?php print $location->location_id; ?>" <?php echo $this->Employee->has_location($location->location_id,$person_info->person_id)?"Selected":"";?>>

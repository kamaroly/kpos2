...

{
   ...
   function is_valid_transfer($transfer_id)

	{
...

		{
			...
			return $this->CI->transfer->exists($transfer_id);
	...
	function receiving_entire_transfer($transfer_id)

	{
		...
		//$this->set_supplier($this->CI->Receiving->get_supplier($transfer_id)->person_id);

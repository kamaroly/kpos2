...
ALTER TABLE `%DBPREFIX%items`
  ADD CONSTRAINT `%DBPREFIX%items_categories_fk` FOREIGN KEY (`category_id`) REFERENCES `%DBPREFIX%items_categories` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `%DBPREFIX%items_ibfk_1` FOREIGN KEY (`supplier_id`) REFERENCES `%DBPREFIX%suppliers` (`person_id`);
